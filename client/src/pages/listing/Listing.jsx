            ...
            }
            {
                listing && !loading && !error && (
                    <div>
                        ...
                        <div
                            className='flex flex-col gap-4 p-3 max-w-4xl  my-5 px-[100px]'>
                            <p
                                className='
                                flex 
                                flex-col 
                            ...
                            <p
                                className='flex items-center mt-6 gap-2 text-slate-600 my-2 text-sm'
                            >
                            ...
                            <div className='flex gap-4'>
                                ...
                                </p>
                                {
                                    listing.offer && (
                                        ...
                                        text-center
                                        p-1
                                        rounded-md'>${listing.regularPrice - +listing.discountPrice}</p>
                                    )
                                }
                            </div>
